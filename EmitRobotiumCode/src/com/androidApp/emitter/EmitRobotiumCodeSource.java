 ...
 */
public class EmitRobotiumCodeSource {
	 ...
	 */
	public static List<LineAndTokens> generateTestCode(EmitRobotiumCodeSource emitter, String eventsFileName) throws FileNotFoundException, IOException, EmitterException {
