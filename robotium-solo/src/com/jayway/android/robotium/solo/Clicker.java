...
class Clicker {
	...
	public Window getViewWindow(View v) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
	    String decorViewClassName = "com.android.internal.policy.impl.PhoneWindow$DecorView";
		String thisField = "this$0";
		Class decorViewClass = Class.forName(decorViewClassName); 
		while (v != null) {
			ViewParent vp = v.getParent();
			if (vp.getClass().equals(decorViewClass)) {
				Window w = (Window) ReflectionUtils.getFieldValue(vp, decorViewClass, thisField);
				return w;
	...
	public Point getWindowPosition(Window w) {
